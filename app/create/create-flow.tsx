...
const DEFAULT_SUPABASE_LOGO_URL =
  "https://isvpyeyfwgpqtnlpykqu.supabase.co/storage/v1/object/public/qr-logos/g4.png"
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      ...
      const qrCodeData = {
        ...
        logo_url: qrCodeState.logoUrl === DEFAULT_LOGO ? DEFAULT_SUPABASE_LOGO_URL : qrCodeState.logoUrl,
      }
